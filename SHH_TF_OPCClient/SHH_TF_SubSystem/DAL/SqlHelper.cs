    ...
    public abstract class SqlHelper
    {
        ...
        public static string LoadDataBase()
        {
            ...
            if (File.Exists("Config.xml"))
            {
                ...
                {
                    doc.Load("Config.xml");
                    Server = doc.SelectSingleNode("Config/Server").InnerText;
                    User = doc.SelectSingleNode("Config/UserName").InnerText;
                    Password = doc.SelectSingleNode("Config/PassWord").InnerText;
                    DataBase = doc.SelectSingleNode("Config/DataBase").InnerText;
                }
                catch
                {
        ...
        public static readonly string connectionString = LoadDataBase();
        ...
        public static DataSet ExecuteDataSet(string v1, string v2, object p)
        {
        ...
        {
            return GetTable(Database.sqlConStr, cmdTye, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(Database.sqlConStr, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(Database.sqlConStr, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(Database.sqlConStr, CommandType.Text, cmdText, commandParameters);
        }
